...
script_dir = '/home/chendanni/Documents/Norms/analysis/MyScripts/RSA';
...
path_out = fullfile(saveLocation, 'Stats',  strcat('RSA_concepImplicit_SR',num2str(sr),'WIN',num2str(win),'SLIDE',num2str(slide),'_', ztrans));
if ~exist (path_out)
    mkdir(path_out)
end
cd (path_out);
