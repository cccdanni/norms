...
function RSA_timeresolved_stim70c3w(subs, work_dir) 
...
path_in  = data_folder;
savName = strcat ('/', 'Results_RSAc3w_', task ,'_SR',num2str(sr),'WIN',num2str(win),'SLIDE',num2str(slide), '_', ztrans, '_'); 
path_out = fullfile(saveLocation, 'Results',strcat('RSAc3w_', task, '_SR',num2str(sr),'WIN',num2str(win),'SLIDE',num2str(slide),'_', ztrans));
mkdir(path_out)
