...
path_out = fullfile(project_folder,'RSA','data',strcat('all_trials_post_sr',num2str(sr),'window','full','slide','none'));
...
%     corr_trials.time_cue=[t1_c;t2_c];
    ...
    save(fullfile(path_out, strcat(all_subs{n},'post_alltrials_full.mat')),'corr_res','erpdata','erpdata3');
