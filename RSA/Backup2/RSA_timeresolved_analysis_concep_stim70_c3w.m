...
path_in  = data_folder;
savName = strcat ('Results_RSAc3w_concepImplicit_SR',num2str(sr),'WIN',num2str(win),'SLIDE',num2str(slide), '_', ztrans, '_'); 

path_pre  = fullfile(saveLocation, 'Results',strcat('RSAc3w_preLearningImplicit_SR',num2str(sr),'WIN',num2str(win),'SLIDE',num2str(slide),'_', ztrans));
path_post = fullfile(saveLocation, 'Results',strcat('RSAc3w_postLearningImplicit_SR',num2str(sr),'WIN',num2str(win),'SLIDE',num2str(slide),'_', ztrans));
path_diff = fullfile(saveLocation, 'Stats',strcat('RSAc3w_concepImplicit_SR',num2str(sr),'WIN',num2str(win),'SLIDE',num2str(slide),'_', ztrans));
if ~exist (path_diff)
    mkdir(path_diff)
end
path_out = path_diff;
...
RDM_pre = load ( strcat (path_pre, '/', 'Results_RSAc3w_preLearningImplicit_SR',num2str(sr),'WIN',num2str(win),'SLIDE',num2str(slide), '_', ztrans, '_trans.mat') );
RDM_post = load ( strcat (path_post, '/', 'Results_RSAc3w_postLearningImplicit_SR',num2str(sr),'WIN',num2str(win),'SLIDE',num2str(slide), '_', ztrans, '_trans.mat') );
