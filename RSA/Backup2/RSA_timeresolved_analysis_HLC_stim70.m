...
for nSub = 1: size (RDM_pre.allsubject_neuralrdm_allbins, 4)
    ...
    for nBin = 1: size (RDM_pre.allsubject_neuralrdm_allbins, 3)
        ...
        for nCond = 1: 6
            allsubject_neuralrdm_allbin_Pre_AVG (nSub, nCond, nBin) = mean (neuralrdm(((nCond-1)*10 +1):nCond*10, 61:70) , 'all');
        end
        ...
        for nCond = 1: 6
            allsubject_neuralrdm_allbin_Post_AVG (nSub, nCond, nBin) = mean (neuralrdm(((nCond-1)*10 +1):nCond*10, 61:70) , 'all');
        end
        ...
        for nCond = 1: 6
            allsubject_neuralrdm_allbin_Diff_AVG (nSub, nCond, nBin) = mean (neuralrdm(((nCond-1)*10 +1):nCond*10, 61:70) , 'all');
        end
...
Results_Stats = struct; 
for iContrast = 1:6
    DiffAVG = squeeze (allsubject_neuralrdm_allbin_Post_AVG(:,contrast_pairs(iContrast, 1),:) - allsubject_neuralrdm_allbin_Post_AVG(:,contrast_pairs(iContrast, 2),:));
    [H, P, ~, STATS] = ttest (DiffAVG, 0, 'alpha', p_first);
    Results_Stats(iContrast).H = H;
    Results_Stats(iContrast).P = P;
    Results_Stats(iContrast).STATS = STATS;
    ...
    if strcmp (perm_test, 'yes')
        ...
        dat1 = squeeze (allsubject_neuralrdm_allbin_Post_AVG(:,contrast_pairs(iContrast, 1),:));
        dat2 = squeeze (allsubject_neuralrdm_allbin_Post_AVG(:,contrast_pairs(iContrast, 2),:));
        dat(:,:,1) = dat1;
        dat(:,:,2) = dat2;
...
Results_Stats = struct; 
for iContrast = 1:6
    DiffAVG = squeeze (allsubject_neuralrdm_allbin_Diff_AVG(:,contrast_pairs(iContrast, 1),:) - allsubject_neuralrdm_allbin_Diff_AVG(:,contrast_pairs(iContrast, 2),:));
    [H, P, ~, STATS] = ttest (DiffAVG, 0, 'alpha', p_first);
    Results_Stats(iContrast).H = H;
    Results_Stats(iContrast).P = P;
    Results_Stats(iContrast).STATS = STATS;
    Results_Stats(iContrast).conditions = contrast_names (iContrast);
    Results_Stats(iContrast).session    = "difference";
    ...
    if strcmp (perm_test, 'yes')
        ...
        dat1 = squeeze (allsubject_neuralrdm_allbin_Diff_AVG(:,contrast_pairs(iContrast, 1),:));
        dat2 = squeeze (allsubject_neuralrdm_allbin_Diff_AVG(:,contrast_pairs(iContrast, 2),:));
        dat(:,:,1) = dat1;
        dat(:,:,2) = dat2;
